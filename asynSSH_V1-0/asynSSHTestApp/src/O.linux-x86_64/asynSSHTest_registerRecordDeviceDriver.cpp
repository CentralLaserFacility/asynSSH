...
/* Generated from ../O.Common/asynSSHTest.dbd */
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_dbndInitialize, pvar_func_drvAsynSSHPortRegisterCommands,
    pvar_func_streamRegistrar, pvar_func_syncInitialize,
    pvar_func_tsInitialize, pvar_func_register_func_parsels,
    pvar_func_register_func_selectFile;
...
int asynSSHTest_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    pvar_func_drvAsynSSHPortRegisterCommands();
    pvar_func_streamRegistrar();
    pvar_func_syncInitialize();
    pvar_func_tsInitialize();
    pvar_func_register_func_parsels();
    pvar_func_register_func_selectFile();
    iocshRegisterVariable(vardefs);
    return 0;
}

/* asynSSHTest_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"asynSSHTest_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    asynSSHTest_registerRecordDeviceDriver(*iocshPpdbbase);
}
